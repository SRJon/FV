...
export class UserService {
    ...
    public async getAll(
        ...
        try {
            const result = await actions.user.UserGetAll(page, limit);
            return result;
        } catch (error) {
            return undefined;
        }
    ...
    public async getById(id: number): Promise<IResponse<IUser> | undefined> {
        try {
            const result = await actions.user.UserGetById(id);
            return result;
        } catch (error) {
            return undefined;
        }
    ...
    public async update(user: IUser): Promise<IResponse<boolean>> {
        try {
            const result = await actions.user.UserUpdate(user);
            return result;
        } catch (error: any) {
            return {
                data: false,
    ...
    public async create(user: IUser): Promise<IResponse<boolean>> {
        try {
            const result = await actions.user.UserCreate(user);
            return result;
        } catch (error: any) {
            return {
                data: false,
    ...
    public async delete(id: number): Promise<IResponse<boolean>> {
        try {
            const result = await actions.user.UserDelete(id);
            return result;
        } catch (error: any) {
            return {
                data: false,
    ...
    public async getUserByToken(
        ...
        const result = await actions.user.LoginGetUserByToken(token);
        if (result.data) {
            return result;
        } else {
