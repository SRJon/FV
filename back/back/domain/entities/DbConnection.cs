...
namespace back.domain.entities
{
    public abstract class DbConnection
    {
        ...
        private string SANKHYA_FVU_TESTE = "Password=DNm*#jrENO7e;Persist Security Info=True;User ID=user_sankhya_fvu;Initial Catalog=FVUDB_TESTE;Data Source=10.200.200.4";
